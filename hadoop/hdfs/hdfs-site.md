...
<property>
  ...
  </description> <!-- namenode rpc通信的rpc地址和端口 eg: hostname:8020-->
</property>
...
<property>
  ...
  </description> <!-- RPC服务器的真实地址，如果为空，则使用dfs.namenode.rpc-address属性中配置的主机名 -->
</property> 
...
<property>
  ...
  </description>  <!-- 用于HDFS服务通信的RPC地址，所有的backupnode,datanode和其它服务都应该连接到这个地址-->
</property>
...
<property>
  ...
  <description>
    ...
    This is useful for making the name node listen on all interfaces by
    setting it to 0.0.0.0.
  </description> <!-- RPC服务器中服务的真实地址，如果为空，则使用dfs.namenode.servicerpc-bind-host属性中配置的主机名, 配置servicerpc 参见hdfs
                 -servicerpc.md-->
</property>
...
<property>
  ...
  </description> <!-- 如果dn挂了，nn会通过这个时间定时检查dn是否真的挂了，nn主动行为，应该是检查两次，默认也就是10分钟-->
</property>
...
<property>
  ...
  </description> <!-- 在选择目标的时候，是否考虑目标的负载情况。 -->
</property>
<property>
  <name>dfs.default.chunk.view.size</name>
  <value>32768</value>
  <description>The number of bytes to view for a file on the browser.
  </description> <!--在浏览器上能查看文件的字节数-->
</property>
...
<property>
  ...
  <description>Defines the maximum number of items that a directory may
      ...
      6400000.</description>  <!-- 每个目录下最多包含子目录或者文件-->
</property>
...
<property>
  ...
  symbolic.</description>  <!--datanode目录权限-->
</property>
...
<property>
  ...
  </description> <!--datanode写入失败时，尝试重新写入的次数-->
</property>
...
<property>
  ...
  </description> <!--如果datanode写入失败，则重新写入新的datanode-->
</property>
...
</property> <!--块报告时间间隔，6个小时，如果dn不上报坏块，nn是不知道的，也就不会恢复坏块-->
...
<property>
    ...
    </description> <!--dn上的block数量大于此值，就分磁盘上报-->
</property>
...
<property>
  ...
  </description> <!--datanode以秒为单位扫描数据目录，并协调内存块和磁盘上的块之间的差异，如果某个块丢失了或者块坏了，这个时候用fsck检查还是显示健康，等到这个时间dn才会扫描到-->
</property>
...
</property> <!--命名一个文件，该文件包含允许连接到namenode的主机列表。必须指定文件的完整路径名。如果值为空，则允许所有主机。-->
...
<property>
  ...
  excluded.</description>  <!--命名一个文件，该文件包含不允许连接到namenode的主机列表。必须指定文件的完整路径名。如果值为空，则不排除任何主机。-->
</property> 
...
<property>
  ...
  </description> <!--DFS支持的文件、目录和块的最大数量。0的值指示DFS支持的对象数目没有限制-->
</property>
...
<property>
  ...
  </description> <!--当为true时，namenode连接datanode的地址必须解析成主机名-->
</property>
...
<property>
  ...
  complete.</description> <!--检查dn退役是否完成-->
</property>
...
<property>
  ...
  </description> <!--每次检查退役期间，处理的block数量-->
</property>
...
<property>
  ...
  </description> <!--同时进入decommisson或maintenance的datanode的数量-->
</property>
...
</property> <!--namenode定期计算datanode副本数量的时间间隔，单位为秒。-->
...
<property>
  ...
  </description> <!--HDFS文件访问时间的精确值，默认为1小时。当为0时，表示禁用。-->
</property>
...
<property>
  ...
  </description> <!--控制默认块放置策略如何放置块的第一个副本。当TRUE时，它将更喜欢客户端正在运行的节点。当FALSE时，它将首选与客户端相同的机架中的节点。-->
</property>
...
</property>  <!--每个校验和的字节数，不能大于dfs.stream-buffer-size属性的值每个校验和的字节数，不能大于dfs.stream-buffer-size属性的值-->

<property>
  <name>dfs.client-write-packet-size</name>
  <value>65536</value>
  <description>Packet size for clients to write</description>
</property> <!--客户端写入的数据包大小-->
...
<property>
  ...
  </description> <!--当加载fsimage或重演edits失败时，重试的次数。-->
</property>
...
<property>
  ...
  </description> <!--在namenode和seccondary namenode中保留image检查点（fsimage_*）的数量-->
</property>
...
<property>
  ...
  </description> <!--namenode的需要保留的额外的事务。-->
</property>
...
<property>
  ...
  </description> <!--namenode中更新委托令牌主密钥的时间间隔，单位为毫秒-->
</property>
...
<property>
  ...
  </description> <!--Datanode停止服务之前允许失败的卷的数量。默认情况下，任何卷故障都会导致datanode关闭-->
</property>
...
<property>
  ...
  </description> <!--如果images被压缩，它们应该如何压缩？必须是 io.compression.codecs属性中定义的编解码器。-->
</property>
...
<property>
  ...
  </description> <!--用于常规image传输的最大带宽，即每秒的字节数。-->
</property>
...
<property>
  ...
  </description> <!--是否允许namenode将自身进行格式化。-->
</property>
...
<property>
  ...
  </description> <!--DataNode可以同时处理的数据传输连接数,即指定在DataNode内外传输数据使用的最大线程数，如果不够会抛异常IOException：Xceiver count
 curXceiverCount exceeds the limit of concurrent xcievers:-->
</property>
...
<property>
  ...
  </description> <!--当为正值时，datanode将按照设定时间间隔进行块扫描。当为负值时，则禁止块扫描。当为0时，则使用默认的504小时（3周）进行定期扫描。-->
</property>
...
<property>
  ...
  </description> <!--当为0时，datanode的块扫描会被禁用，当为正数时，该属性为datanode每秒扫描的字节数。-->
</property>
...
<property>
  ...
  </description> <!--指示故障转移IPC客户端将建立服务器连接的重试次数-->
</property>
...
<property>
  ...
  </description> <!--/dev/shm/是linux下一个非常有用的目录，因为这个目录不在硬盘上，而是在内存里。因此在linux下，就不需要大费周折去建ramdisk，直接使用/dev/shm/就可达到很好的优化效果。 /dev /shm/需要注意的一个是容量问题，在linux下，它默认最大为内存的一半大小，使用df -h命令可以看到。但它并不会真正的占用这块内存，如果/dev/shm/下没有任何文件，它占用的内存实际上就是0字节；如果它最大为1G，里头放有 100M文件，那剩余的900M仍然可为其它应用程序所使用，但它所占用的100M内存，是绝不会被系统回收重新划分的，否则谁还敢往里头存文件呢？
...
<property>
  ...
  </description> <!--是否允许读取"陈旧"datanode（也就是在设定时间间隔内没有向namenode发送心跳消息的节点）。-->
</property>
...
<property>
  ...
  <description>
    ...
    for reads.
  </description> <!--是否允许写入“陈旧”datanode（也就是在设定时间间隔内没有向namenode发送心跳消息的节点）。-->
</property>                            
...
<property>
  ...
  </description> <!--在设定的这个时间里，如果namenode没有收到datanode的心跳消息，则将datanode置为“陈旧”datanode，单位为毫秒。-->
</property>
...
<property>
  ...
  </description> <!--当陈旧datanode的数量占比超过设置的值时，会停止写入陈旧的datanode。-->
</property>
...
<property>
  ...
  </description> <!--注意：高级属性。谨慎改变。该属性决定了单条datanode心跳删除命令进行块无效（删除）的百分比。0.32f表示100%。-->
</property>
...
<property>
  ...
  <description>
    *Note*: Advanced property. Change with caution.
    ...
    non-zero integer.
  </description> <!--注意：高级属性。谨慎改变。Datanode并行传输时的块数量。这个数字可以是任何正、非零整数。-->
</property>
...
</property> <!--是否允许在namenode和datanode中启用WebHDFS (REST API)-->
...
<property>
  ...
  <description>
    ...
    connection objects.
  </description> <!--在fuse_dfs中缓存libhdfs连接对象的最小秒数。较低的值将导致较低的内存消耗；较高的值可以通过避免创建新连接对象的开销来加快访问速度。-->
</property>
...
<property>
  ...
  <description>
    ...
    quickly.
  </description> <!--fuse_dfs中缓存过期检查之间的秒数。-->
</property>
...
<property>
  ...
  <description>
    ...
    not defined.
  </description> <!--密码组合有四种：AES/CTR/NoPadding或者未定义-->
</property>
...
<property>
  ...
  </description> <!--client和datanode之间的密钥位长度，值有128，192和256三种。-->
</property>
...
<property>
  ...
  <description>
      ...
      is not trusted.
  </description> <!--TrustedChannelResolver用于确定通道是否受信任以用于普通数据传输。-->
</property>
...
<property>
  ...
  </description> <!--用于读取或写入块数据时与datanode的安全连接。选项有authentication, integrity and privacy三种，需要保证客户端和服务端配置一样-->
</property>
...
<property>
  ...
  </description> <!--客户端可以call getFileBlockStorageLocations这个API来获取Block(BLOCKLOCATION)与disk(VOLUMNS)的映射-->
</property>
...
<property>
  ...
  </description> <!--DistributedFileSystem#getFileBlockStorageLocations()中进行并行RPC的线程数-->
</property>
...
<property>
  ...
  </description> <!--DistributedFileSystem#getFileBlockStorageLocations()中进行RPC的超时时间，单位为毫秒-->
</property>
