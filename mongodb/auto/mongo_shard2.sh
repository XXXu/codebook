...
PORT=27022
SHARDNAME="TranswarpMongoShard2"
SHARD_DB_PATH=/mnt/disk1/mongodb/arbiter
PIDFILE=$PID_PATH/mongodb-shard2.pid
LOG_PATH=/var/log/mongodb/mongodb-shard2-$(hostname).log
LOCKFILE="$LOCKDIR/mongodb-shard2"
