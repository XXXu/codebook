...
PORT=27020
SHARDNAME="TranswarpMongoShard0"
SHARD_DB_PATH=/mnt/disk1/mongodb/data
PIDFILE=$PID_PATH/mongodb-shard0.pid
LOG_PATH=/var/log/mongodb/mongodb-shard0-$(hostname).log
LOCKFILE="$LOCKDIR/mongodb-shard0"
